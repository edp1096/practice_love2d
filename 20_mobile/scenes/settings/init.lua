...
local render_module = require "scenes.settings.render"
local input_module = require "scenes.settings.input"
...
function settings:enter(previous, ...)
    ...
    -- Volume indices
    self.current_master_volume_index = options_module:findVolumeLevel(require("systems.sound").settings.master_volume)
    self.current_bgm_volume_index = options_module:findVolumeLevel(require("systems.sound").settings.bgm_volume)
    self.current_sfx_volume_index = options_module:findVolumeLevel(require("systems.sound").settings.sfx_volume)
