...
--   GetVirtualDimensions() - Get virtual resolution (1280x720)
...
function screen:ShowDebugInfo()
    ...
    love.graphics.rectangle("fill", 0, 0, 280, 180)
    ...
    love.graphics.print("Offset: " .. string.format("%.1f", offsetX) .. ", " .. string.format("%.1f", offsetY), 10, 70)
    love.graphics.print("Mode: " .. self.scale_mode, 10, 90)

    -- Virtual mouse coordinates
    local vmx, vmy, mx, my = self:GetVirtualMousePosition()
    love.graphics.print("Mouse: " .. string.format("%.1f", vmx) .. ", " .. string.format("%.1f", vmy), 10, 110)

    -- Instructions
    love.graphics.print("F11: Fullscreen", 10, 140)
    love.graphics.print("F10: Scale Mode", 10, 160)
