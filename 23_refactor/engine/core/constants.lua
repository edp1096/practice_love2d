...
constants.COLLISION_CLASSES = {
    ...
    PLAYER_MOVEMENT = "PlayerMovement",  -- Topdown mode: bottom collider for wall collision
    ENEMY = "Enemy",
    WALL = "Wall",
    WALL_MOVEMENT = "WallMovement",      -- Topdown mode: bottom surface for player to walk on
    NPC = "NPC",
    WEAPON = "Weapon",
