...
local combat = require "game.entities.player.combat"
local render = require "game.entities.player.render"
local animation = require "game.entities.player.animation"
