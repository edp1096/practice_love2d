return {
    ...
    strings = {
        ...
        ["ui.shop.sold"] = "Sold.",
        ["ui.input.move"] = "Move: WASD/arrows",
        ["ui.input.jump"] = "Jump: W/Up",
        ["ui.input.attack"] = "Attack: Space",
        ["ui.input.special"] = "Ranged: F",
        ["ui.input.technique"] = "Whirlwind: Q",
        ["ui.input.dodge"] = "Dodge: Shift",
        ["ui.input.parry"] = "Parry: C",
        ["ui.input.interact"] = "Interact: E",
        ["ui.input.restart"] = "Restart: R",
