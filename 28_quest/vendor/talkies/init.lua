...
function Talkies.draw()
  ...
  -- MODIFIED: Use virtual resolution if available
  local function getDimensions()
    -- Try global screen first (for engine.display)
    if _G.screen and _G.screen.GetVirtualDimensions then
      return _G.screen:GetVirtualDimensions()
    end
