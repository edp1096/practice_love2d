...
### 최신 변경사항 (2025-11-19)
- **PlayStation 버튼 아이콘** - DualSense 공식 색상(✕○□△)으로 Shape 그리기
- **컨트롤러 자동 감지** - PlayStation vs Xbox 자동 구분
- **동적 버튼 프롬프트** - UI 전체에서 올바른 버튼명/아이콘 표시
- **UI 레이아웃 개선** - 탭 좌측 정렬, 제목 중앙, 닫기 버튼 패널 끝 정렬
