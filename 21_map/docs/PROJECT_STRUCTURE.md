...
├── effects.lua           - Particle effects system
├── hud.lua               - HUD rendering (health bars, cooldowns)
...
│   ├── input_coordinator.lua           - Coordinates multiple input sources
...
└── utils/                - Engine utilities
    ...
    ├── scene_ui.lua      - Reusable UI components
...
**Purpose:** Game-specific content (like RPG Maker's "project" folder).
...
**Purpose:** Wrappers for third-party libraries.

```
lib/
├── screen/
│   └── init.lua          - Virtual resolution system (960x540)
├── text/
