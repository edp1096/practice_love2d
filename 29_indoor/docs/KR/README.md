...
**2025-11-22: 미니맵 & 전리품 시스템 개선**
- **미니맵 패럴랙스** - 미니맵에 패럴랙스 배경 추가 (static offset 방식)
- **미니맵 렌더링** - `anim:draw()` 사용으로 엔티티 위치 수정
- **전리품 시스템** - enemy config에 `loot_category` 필드 추가, 하드코딩된 테이블 이름 매칭 제거

**2025-11-19: 코드 품질 & 리팩토링**
