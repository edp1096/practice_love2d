...
hand_anchors.HAND_ANCHORS = {
    ...
    run_right = {
        ...
        { x = -6,  y = 6, angle = -math.pi / 12 },
        { x = -7, y = 3, angle = -math.pi / 12 },
        { x = 1, y = 8, angle = -math.pi / 12 },
        { x = 7, y = 3, angle = -math.pi / 12 },
        { x = 9,  y = 0, angle = -math.pi / 12 },
    },
    run_left = {
        { x = 2,  y = 5, angle = math.pi },
        { x = -8,  y = 4, angle = math.pi },
        { x = -11, y = 0, angle = math.pi },
        { x = -5, y = 5, angle = math.pi },
        { x = 5, y = 3, angle = math.pi },
        { x = 7,  y = 3, angle = math.pi },
    },
    run_down = {
        { x = -4, y = 8, angle = math.pi / 2 },
        { x = 0, y = 2, angle = 1.7708 },
        { x = -1, y = 0, angle = 1.3708 },
        { x = -6, y = 6, angle = math.pi / 2 },
        { x = -7, y = 6, angle = 1.7708 },
        { x = -10, y = 0, angle = 1.3708 },
    },
    run_up = {
        { x = 5, y = 6, angle = -math.pi / 2 },
        ...
        { x = 6, y = 4, angle = -1.3708 },
        { x = 6, y = 6, angle = -1.7708 },
    },
