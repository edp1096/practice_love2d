...
function player:new(sprite_sheet, x, y)
    ...
    instance.animations = {}
    instance.animations.up = anim8.newAnimation(instance.grid("1-4", 4), 0.1)
    instance.animations.down = anim8.newAnimation(instance.grid("1-4", 3), 0.1)
    instance.animations.left = anim8.newAnimation(instance.grid("5-8", 4, "1-2", 5), 0.1)
    instance.animations.right = anim8.newAnimation(instance.grid("3-8", 5), 0.1)

    instance.anim = instance.animations.right
