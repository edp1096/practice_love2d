...
local combat = require "game.entities.weapon.combat"
local render = require "game.entities.weapon.render"
local hand_anchors = require "game.entities.weapon.config.hand_anchors"
local swing_configs = require "game.entities.weapon.config.swing_configs"
local handle_anchors = require "game.entities.weapon.config.handle_anchors"
local sword_types = require "game.entities.weapon.types.sword"
