...
if USE_REFACTORED_MAIN then
    local success, module = pcall(require, "systems.main_refactored")
    if success then
        main_refactored = module
        print("✓ Using refactored main system")
    else
        print("✗ Failed to load refactored main, falling back to legacy: " .. tostring(module))
        USE_REFACTORED_MAIN = false
    end
end

-- If refactored system is enabled, use it
if USE_REFACTORED_MAIN and main_refactored then
    ...
    -- Legacy system (original code preserved)
